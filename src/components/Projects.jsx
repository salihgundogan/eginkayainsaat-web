  ...
  return (
    <section id="projects" className="section-padding bg-white">
      <div className="container-max">
        ...
        >
          <span className="mb-4 text-sm font-semibold tracking-widest text-red-600 uppercase">
            Referanslarımız
          </span>

          <h2 className="heading-primary mb-6 text-center">
            İmzamızı Attığımız İşler
          </h2>

          <p className="max-w-2xl text-gray-500 text-lg leading-relaxed text-center">
